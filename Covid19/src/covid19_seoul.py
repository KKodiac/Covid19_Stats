...
class CovidInfoSeoul:
    ...
    def run(self):
        ...
        for i in range(0, len(tables)):
            ...
            # save as csv files
            df_crawl.to_csv("./Covid19/Data/Korea/seoul_timeseries/" + str(i) + ".csv")
        ...
        for i in range(0, len(tables)):
            ...
            df_not_validated = pd.read_csv(
                "./Covid19/Data/Korea/seoul_timeseries/" + str(i) + ".csv"
            )
        ...
        df_confirmed.to_csv("./Covid19/Data/Korea/covid_dat_seoul.csv")
